...
public class Estudante  implements java.io.Serializable {
     ...
     private Set<Realiza> realizas = new HashSet<>(0);
...
public String toString() {
    ...
    sb.append("Estudante{");
    sb.append("nrMatricula=").append(nrMatricula);
    sb.append(", curso=").append(curso != null ? curso.getId() : "null");
    sb.append(", turma=").append(turma != null ? turma.getId() : "null");
    ...
    if (realizas != null && !realizas.isEmpty()) {
        for (Realiza realiza : realizas) {
            sb.append("{")
              .append("id_estudante=").append(realiza.getId().getIdEstudante())
              .append(", id_avaliacao=").append(realiza.getId().getIdAvaliacao())
              .append(", nota=").append(realiza.getNota())
              .append("}, ");
        }
